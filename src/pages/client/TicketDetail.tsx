...
import { ArrowLeft, Clock, Send, Loader2, RefreshCw } from 'lucide-react';
  ...
  if (!ticketData) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-slate-600 mb-4">This ticket may have been deleted or you don't have permission to view it.</p>
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <span className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(ticketData.status)}`}>
